...
if (!text) throw `*خطأ اكتب مثال*\n*${usedPrefix + command} سورة المؤمنون*`
try { 
...
await conn.sendList(m.chat, `*نتائج ${text}*`, `\n${htki} *انا غير مسئول عن ما تبحث عنه وتذكر ان الله يراك* ${htka}`, `🍄 اختار صوت ولا صوره 🍁`, listSections, {quoted: fkontak});
} catch (e) {
